                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="row g-3 g-md-4 row-cols-1 row-cols-sm-2">
                                            <div className="col ">
                                                ...
                                                <input type="text" className="form-control py-3" name='first_name' id="first-name" onChange={handleChange} placeholder="e.g. Muhammad" />
                                            </div>
                                            <div className="col ">
                                                <label htmlFor="last-name" className="form-label">Last Name</label>
                                                <input type="text" className="form-control py-3" id="last-name" name='last_name' onChange={handleChange} placeholder="e.g. Usman" />
                                            </div>
                                            <div className="col ">
                                            ...
                                            <div className="col ">
                                                ...
                                                <input type="tel" className="form-control py-3" id="phone-number" name='phone' onChange={handleChange} placeholder="+923009090990" />
                                            </div>
                                            <div className="col ">
